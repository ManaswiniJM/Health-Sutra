...
public class display_general_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(display_general_admin.this, R.color.black));
        ...
        if (disease != null) {
            firestore.collection("General")
                    ...
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(display_general_admin.this, "Disease deleted successfully!", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(e -> {
                        Toast.makeText(display_general_admin.this, "Error deleting disease: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
    @Override
