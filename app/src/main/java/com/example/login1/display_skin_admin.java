...
public class display_skin_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(display_skin_admin.this, R.color.black));
    ...
    private void deleteDiseaseFromFirestore() {
        if (disease != null) {
            firestore.collection("Skin")
                    .document(disease.getId())
                    .delete()
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(display_skin_admin.this, "Disease deleted successfully!", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(e -> {
                        Toast.makeText(display_skin_admin.this, "Error deleting disease: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
    @Override
