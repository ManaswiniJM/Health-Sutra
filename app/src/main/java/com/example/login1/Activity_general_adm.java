...
public class Activity_general_adm extends AppCompatActivity implements OnQueryTextListener {
    ...
    DiseaseAdapterGeneral diseaseAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_general_adm);

        getWindow().setStatusBarColor(ContextCompat.getColor(Activity_general_adm.this, R.color.black));
        ...
        diogrec = findViewById(R.id.grecyclerViewAdm);
        searchView = findViewById(R.id.gsearchViewAdm);
        add = findViewById(R.id.gdiseaseAdd);
        ...
        diseaseAdapter = new DiseaseAdapterGeneral(this, filteredDiseaseList);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Activity_general_adm.this, DiseaseAddGeneral.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Activity_general_adm.this, "Error" + task.getException(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
