...
public class Activity_skin_adm extends AppCompatActivity implements OnQueryTextListener {
    ...
    DiseaseAdapterSkin diseaseAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_skin_adm);

        getWindow().setStatusBarColor(ContextCompat.getColor(Activity_skin_adm.this, R.color.black));
        ColorDrawable colorDrawable
                = new ColorDrawable(Color.parseColor("#39a9e87c"));
        getSupportActionBar().setBackgroundDrawable(colorDrawable);
        getSupportActionBar().setTitle("Skin Disease");

        db = FirebaseFirestore.getInstance();
        diogrec = findViewById(R.id.srecyclerViewAdm);
        searchView = findViewById(R.id.ssearchViewAdm);
        add = findViewById(R.id.diseaseAdd);
        ...
        diseaseAdapter = new DiseaseAdapterSkin(this, filteredDiseaseList);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Activity_skin_adm.this, DiseaseAddSkin.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Activity_skin_adm.this, "Error" + task.getException(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
