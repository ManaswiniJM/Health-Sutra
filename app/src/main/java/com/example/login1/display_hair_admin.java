...
public class display_hair_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(display_hair_admin.this, R.color.black));
    ...
    private void deleteDiseaseFromFirestore() {
        if (disease != null) {
            firestore.collection("Hair")
                    .document(disease.getId())
                    .delete()
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(display_hair_admin.this, "Disease deleted successfully!", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(e -> {
                        Toast.makeText(display_hair_admin.this, "Error deleting disease: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
    @Override
