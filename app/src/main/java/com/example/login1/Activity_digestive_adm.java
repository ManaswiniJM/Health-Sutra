...
public class Activity_digestive_adm extends AppCompatActivity implements OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_digestive_adm);

        getWindow().setStatusBarColor(ContextCompat.getColor(Activity_digestive_adm.this, R.color.black));
        ...
        diogrec = findViewById(R.id.drecyclerViewAdm);
        searchView = findViewById(R.id.dsearchViewAdm);
        add = findViewById(R.id.ddiseaseAdd);
        ...
        diseaseAdapter = new DiseaseAdapterDigestive(this, filteredDiseaseList);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Activity_digestive_adm.this, DiseaseAddDigestive.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Activity_digestive_adm.this, "Error" + task.getException(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
