...
public class DiseaseAddDigestive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(DiseaseAddDigestive.this, R.color.black));
            ...
            public void onClick(View view) {
                ...
                db.collection("Digestive")
                        ...
                        .addOnSuccessListener(documentReference -> {
                            Toast.makeText(DiseaseAddDigestive.this, "Disease added successfully!", Toast.LENGTH_SHORT).show();
                            setResult(RESULT_OK); // Set the result to indicate success
                            finish(); // Close the current activity and return to the previous one
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(DiseaseAddDigestive.this, "Error adding disease: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
            }
        });
    }
