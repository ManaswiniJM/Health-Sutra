...
public class DiseaseAddSkin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(DiseaseAddSkin.this, R.color.black));
            ...
            public void onClick(View view) {
                ...
                db.collection("Skin")
                        ...
                        .addOnSuccessListener(documentReference -> {
                            Toast.makeText(DiseaseAddSkin.this, "Disease added successfully!", Toast.LENGTH_SHORT).show();
                            setResult(RESULT_OK); // Set the result to indicate success
                            finish(); // Close the current activity and return to the previous one
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(DiseaseAddSkin.this, "Error adding disease: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
            }
        });
    }
