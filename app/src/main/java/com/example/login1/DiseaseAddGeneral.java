...
public class DiseaseAddGeneral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(DiseaseAddGeneral.this, R.color.black));
            ...
            public void onClick(View view) {
                ...
                db.collection("General")
                        ...
                        .addOnSuccessListener(documentReference -> {
                            Toast.makeText(DiseaseAddGeneral.this, "Disease added successfully!", Toast.LENGTH_SHORT).show();
                            setResult(RESULT_OK); // Set the result to indicate success
                            finish(); // Close the current activity and return to the previous one
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(DiseaseAddGeneral.this, "Error adding disease: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
            }
        });
    }
